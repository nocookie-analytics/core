...
def upgrade():
    ...
    sa.Column('event_type', sqlalchemy_enum34.Enum('page_view', 'custom'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['domain_id'], ['domain.id'], name='fk_event_domain_id'),
    sa.PrimaryKeyConstraint('domain_id', 'timestamp', 'id')
    )
    op.create_index('ix_domain_timestamp', 'event', ['domain_id', 'timestamp'], unique=False)
