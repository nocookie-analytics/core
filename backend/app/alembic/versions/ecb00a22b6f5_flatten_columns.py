...
def upgrade():
    ...
    op.add_column(
        "event", sa.Column("browser_version_major", sa.String(), nullable=True)
    )
    op.add_column(
        "event", sa.Column("browser_version_minor", sa.String(), nullable=True)
    )
    ...
    op.add_column("event", sa.Column("metric_value", sa.NUMERIC(), nullable=True))
    ...
    op.create_index(
        op.f("ix_event_browser_family"), "event", ["browser_family"], unique=False
    )
    op.create_index(
        op.f("ix_event_device_brand"), "event", ["device_brand"], unique=False
    )
    op.create_index(
        op.f("ix_event_device_family"), "event", ["device_family"], unique=False
    )
    op.create_index(
        op.f("ix_event_device_model"), "event", ["device_model"], unique=False
    )
    op.create_index(
        op.f("ix_event_metric_name"), "event", ["metric_name"], unique=False
    )
